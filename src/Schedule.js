...
class Schedule {
    ...
    getSessions() {
        const isScheduleEmpty =
            this.document.querySelector("#dvContainer tbody")
                .innerHTML === "";
        if (isScheduleEmpty)
        ...
        for (let i = 0; i < sessions.length; i++) {
            ...
            if (
                ...
                firstCell.textContent.includes(this.major.fullName)
            ) {
                // SubGroup Row
                ...
                console.log({ subGroup, day, time, subject, professor, type, room, regime })
            }
